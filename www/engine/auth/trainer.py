...
path = 'www\\engine\\auth\\samples' # Path for samples already taken

recognizer = cv2.face.LBPHFaceRecognizer_create() # Local Binary Patterns Histograms
detector = cv2.CascadeClassifier("www\\engine\\auth\\haarcascade_frontalface_default.xml")
...
recognizer.write('www\\engine\\auth\\trainer\\trainer.yml')  # Save the trained model as trainer.yml
